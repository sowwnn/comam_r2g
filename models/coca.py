...
class Croco(nn.Module):
    def __init__(
        ...
        *,
        ...
        # Thêm Cross-Region Attention
        self.cross_region_attn = CrossRegionAttention(
            dim=dim, 
            num_heads=heads,
            region_ann_path=region_ann_path,
    ...
    def forward(
        ...
        # Áp dụng Cross-Region Attention để tăng cường tương tác giữa hình ảnh và văn bản
        enhanced_image_tokens, enhanced_text_tokens, image_embeds_enhanced, text_embeds_enhanced, _, _ = self.cross_region_attn(
            img_regions=image_tokens, 
            text_tokens=text_tokens,
            text_token_ids=text
        )
        
        # Sử dụng enhanced tokens
        image_tokens = enhanced_image_tokens
        
        # Cập nhật embeds nếu text_embeds_enhanced không phải None
        if exists(text_embeds_enhanced) and exists(image_embeds_enhanced):
            text_embeds = text_embeds_enhanced
            image_embeds = image_embeds_enhanced
